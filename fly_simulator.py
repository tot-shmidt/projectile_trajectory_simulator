...
# initial_speed    - How fast the bottle is moving when it leaves the hand
...
def main():
    ...
    print(f"\nSimulation Starting!")
    print(f"Velocity: {parameters.initial_speed} m/s")
...
def get_input_parameters() -> Parameters:
    ...
    return Parameters(initial_height=h, initial_speed=v, launch_angle=a, angular_velocity=w, com_offset=com)
